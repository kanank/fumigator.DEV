...
const
  AppCaption = 'ѕерва€ фумигационна€ компани€';
...
type
  ...
  protected
    ...
    fInUpdate: Boolean; //признак сохранени€
    fOnTopMost: Boolean; //находитс€ в режиме TopMost
    fTransfered: Boolean;
    fCallObj: TCallProto;
    fNoDefaultCallEvent: Boolean; //не использовать событи€ звонков по умолчанию
  ...
  public
    ...
    procedure ShowLightModal(AProc: TNotifyEvent); //м€гкий ShowModal с потоком
  published
...
begin
  ...
  fCanClose := True;
  fNoDefaultCallEvent := True; //по умолчанию гасим событи€
end;
